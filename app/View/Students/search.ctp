 ...
 <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="box box-default">
        ...
        <!-- /.box-header -->
       <?php echo $this->Form->create('Home', array('type' => 'get', 'url' => array('controller' => 'Students', 'action' => 'search')));?>
        <div class="box-body ">
          <div class="row">
...
<div class="box-body">
        ...
        foreach ($values AS $value) {
          ...
          $name = $this->Html->link($value[$model]['name'], array('controller' =>'Payments', 'action' => 'index', $value[$model]['id']));  
          $rows[] = array(
            $name,            
            $value['Batch']['name'],
            $value[$model]['email'],
